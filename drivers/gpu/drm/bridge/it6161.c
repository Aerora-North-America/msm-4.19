...
# define MIPI_DSI_MODE_VIDEO_NO_HFP	MIPI_DSI_MODE_VIDEO_HFP
#endif

#ifndef MIPI_DSI_MODE_VIDEO_NO_HBP
# define MIPI_DSI_MODE_VIDEO_NO_HBP	MIPI_DSI_MODE_VIDEO_HBP
#endif

#ifndef MIPI_DSI_MODE_VIDEO_NO_HSA
# define MIPI_DSI_MODE_VIDEO_NO_HSA	MIPI_DSI_MODE_VIDEO_HSA
#endif
//#########################################################################
...
static int it6161_i2c_probe(struct i2c_client *i2c_mipi_rx, const struct i2c_device_id *id)
{
